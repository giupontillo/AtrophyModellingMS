...
model_gam_bl <- bam(atrophy_rate ~ s(atrophy_bl) + s(x,y,z) + s(age) + sex + subcortical + s(id, bs = 're') + s(node, bs = 're') + s(atrophy_bl, node, bs = 're'), data = df_GAM, na.action = na.fail, method = "fREML", select = TRUE, discrete = FALSE, nthreads = 8)
