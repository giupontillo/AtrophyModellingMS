...
#SBATCH --job-name=transdeg 		#a name for your job
...
python /data/anw/knw-work/g.pontillo/predictive_modelling/code/stats/AtrophyModelling/scripts/02.indv/TransDeg_Indv.py
