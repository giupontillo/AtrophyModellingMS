...
#SBATCH --job-name=transvul 		#a name for your job
...
python /data/anw/knw-work/g.pontillo/predictive_modelling/code/stats/AtrophyModelling/scripts/02.indv/TransVul_Indv.py
