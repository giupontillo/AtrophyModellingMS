...
#SBATCH --job-name=axonaldisc 		#a name for your job
...
python /data/anw/knw-work/g.pontillo/predictive_modelling/code/stats/AtrophyModelling/scripts/02.indv/AxDisc_Indv.py
