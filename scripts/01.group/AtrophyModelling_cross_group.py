...
atrophy_cross_group2_100 = pd.read_csv(f"{atrophycross_dir}/atrophy_baseline_SchaeferSubcortex114Parcels_group2_cohend.csv")
atrophy_cross_group2_400 = pd.read_csv(f"{atrophycross_dir}/atrophy_baseline_SchaeferSubcortex414Parcels_group2_cohend.csv")
#%%

mean_val = atrophy_cross_group2_100.mean(axis=1).iloc[0]
std_val = atrophy_cross_group2_100.std(axis=1, ddof=1).iloc[0] 
#%%
...
# 
# file_mapping = {
#     f"{conn}_{region}_{res}_{group2}": f"PrograMS_{conn}_SchaeferSubcortex{res}Parcels_{group2}_{region}.csv"   
...
rvals_crossgroup_100, p_and_d_crossgroup_100, meas_crossgroup_100 = nodal_stress(fc_ctx_dc_100, fc_sctx_dc_100, sc_ctx_dc_100, sc_sctx_dc_100, atrophy_cross_group2_100, "schaefer_100")
rvals_crossgroup_400, p_and_d_crossgroup_400, meas_crossgroup_400 = nodal_stress(fc_ctx_dc_400, fc_sctx_dc_400, sc_ctx_dc_400, sc_sctx_dc_400, atrophy_cross_group2_400, "schaefer_400")
    
plot_null_distributions(p_and_d_crossgroup_100, rvals_crossgroup_100, "plot_nodalstress_group2_cross_100_null" )
plot_null_distributions(p_and_d_crossgroup_400, rvals_crossgroup_400, "plot_nodalstress_group2_cross_400_null")

plot_hubs_vs_atrophy(p_and_d_crossgroup_100, rvals_crossgroup_100, meas_crossgroup_100, "plot_nodalstress_group2_cross_100")
plot_hubs_vs_atrophy(p_and_d_crossgroup_400, rvals_crossgroup_400, meas_crossgroup_400, "plot_nodalstress_group2_cross_400")
...
rvals_neighcross_100, p_and_d_neighcross_100, meas_neighcross_100 = neighbour_atrophy(neighcross_group_100_fc_ctx, neighcross_group_100_fc_sctx, neighcross_group_100_sc_ctx, neighcross_group_100_sc_sctx, atrophy_cross_group2_100, "schaefer_100")
rvals_neighcross_400, p_and_d_neighcross_400, meas_neighcross_400 = neighbour_atrophy(neighcross_group_400_fc_ctx, neighcross_group_400_fc_sctx, neighcross_group_400_sc_ctx, neighcross_group_400_sc_sctx, atrophy_cross_group2_400, "schaefer_400")

plot_null_distributions(p_and_d_neighcross_100, rvals_neighcross_100, "plot_neigh_group2_cross_100_null")
plot_null_distributions(p_and_d_neighcross_400, rvals_neighcross_400, "plot_neigh_group2_cross_400_null")

plot_hubs_vs_atrophy(p_and_d_neighcross_100, rvals_neighcross_100, meas_neighcross_100, "plot_neigh_group2_cross_100")
plot_hubs_vs_atrophy(p_and_d_neighcross_400, rvals_neighcross_400, meas_neighcross_400, "plot_neigh_group2_cross_400")
...
#rvals_disc_100, p_and_d_disc_100, meas_disc_100  = axonal_disc(disc_ctx_dc_100, disc_sctx_dc_100, atrophy_cross_group2_100, "schaefer_100")
#rvals_disc_400, p_and_d_disc_400, meas_disc_400  = axonal_disc(disc_ctx_dc_400, disc_sctx_dc_100, atrophy_cross_group2_400, "schaefer_400")
...
rvals_parcel_100, p_and_d_parcel_100, meas_parcel_100  = axonal_disc(parcel_group_100_ctx.squeeze(), parcel_group_100_sctx.squeeze(), atrophy_cross_group2_100, "schaefer_100")
rvals_parcel_400, p_and_d_parcel_400, meas_parcel_400  = axonal_disc(parcel_group_400_ctx.squeeze(), parcel_group_400_sctx.squeeze(), atrophy_cross_group2_400, "schaefer_400")

plot_null_distributions(p_and_d_parcel_100, rvals_parcel_100, "plot_parcel_group2_cross_100_null")
plot_null_distributions(p_and_d_parcel_400, rvals_parcel_400, "plot_parcel_group2_cross_400_null")

plot_hubs_vs_atrophy(p_and_d_parcel_100, rvals_parcel_100, meas_parcel_100, "plot_parcel_group2_cross_100")
plot_hubs_vs_atrophy(p_and_d_parcel_400, rvals_parcel_400, meas_parcel_400, "plot_parcel_group2_cross_400")
...
rvals_cge_100, p_and_d_cge_100, meas_cge_100 = transcriptomic_vulnerablity(cge_group_100_ctx, cge_group_100_sctx, atrophy_cross_group2_100, "schaefer_100")
rvals_cge_400, p_and_d_cge_400, meas_cge_400 = transcriptomic_vulnerablity(cge_group_400_ctx, cge_group_400_sctx, atrophy_cross_group2_400, "schaefer_400")

plot_null_distributions(p_and_d_cge_100, rvals_cge_100, "plot_cge_group2_cross_100_null")
plot_null_distributions(p_and_d_cge_400, rvals_cge_400, "plot_cge_group2_cross_400_null")

plot_hubs_vs_atrophy(p_and_d_cge_100, rvals_cge_100, meas_cge_100, "plot_cge_group2_cross_100")
plot_hubs_vs_atrophy(p_and_d_cge_400, rvals_cge_400, meas_cge_400, "plot_cge_group2_cross_400")
