...
atrophy_cross_group_100_fdr = pd.read_csv(f"{atrophycross_dir}/atrophy_baseline_SchaeferSubcortex114Parcels_group_pfdr.csv")
atrophy_cross_group_400_fdr = pd.read_csv(f"{atrophycross_dir}/atrophy_baseline_SchaeferSubcortex414Parcels_group_pfdr.csv")

atrophy_cross_group_100 = pd.read_csv(f"{atrophycross_dir}/atrophy_baseline_SchaeferSubcortex114Parcels_group_cohend.csv")
atrophy_cross_group_400 = pd.read_csv(f"{atrophycross_dir}/atrophy_baseline_SchaeferSubcortex414Parcels_group_cohend.csv")
#%%
...
neighcross_group_100_fc_ctx = pd.read_csv(f"{neighdir}/neighbourhood_atrophy_cross_SchaeferSubcortex114Parcels_group_fc_ctx.csv")
neighcross_group_100_fc_sctx = pd.read_csv(f"{neighdir}/neighbourhood_atrophy_cross_SchaeferSubcortex114Parcels_group_fc_sctx.csv")
neighcross_group_100_sc_ctx = pd.read_csv(f"{neighdir}/neighbourhood_atrophy_cross_SchaeferSubcortex114Parcels_group_sc_ctx.csv")
neighcross_group_100_sc_sctx = pd.read_csv(f"{neighdir}/neighbourhood_atrophy_cross_SchaeferSubcortex114Parcels_group_sc_sctx.csv")

neighcross_group_400_fc_ctx = pd.read_csv(f"{neighdir}/neighbourhood_atrophy_cross_SchaeferSubcortex414Parcels_group_fc_ctx.csv")
neighcross_group_400_fc_sctx = pd.read_csv(f"{neighdir}/neighbourhood_atrophy_cross_SchaeferSubcortex414Parcels_group_fc_sctx.csv")
neighcross_group_400_sc_ctx = pd.read_csv(f"{neighdir}/neighbourhood_atrophy_cross_SchaeferSubcortex414Parcels_group_sc_ctx.csv")
neighcross_group_400_sc_sctx = pd.read_csv(f"{neighdir}/neighbourhood_atrophy_cross_SchaeferSubcortex414Parcels_group_sc_sctx.csv")

#%%
# ################# DISCONNECTOME DATA FROM AMSTERDAM ################# 
discdir = f'{dir}/data/disc'

disc_group_100_ctx = pd.read_csv(f"{discdir}/disc_SchaeferSubcortex114Parcels_group_ctx.csv", header=None)
disc_group_100_sctx = pd.read_csv(f"{discdir}/disc_SchaeferSubcortex114Parcels_group_sctx.csv", header=None)

disc_group_400_ctx = pd.read_csv(f"{discdir}/disc_SchaeferSubcortex414Parcels_group_ctx.csv", header=None)
disc_group_400_sctx = pd.read_csv(f"{discdir}/disc_SchaeferSubcortex414Parcels_group_sctx.csv", header=None)

#%%
# ################# NEIGHBOUR DATA WEIGHTED BY GENE #################

cge_group_100_ctx = pd.read_csv(f"{neighdir}/neighbourhood_atrophy_cross_SchaeferSubcortex114Parcels_group_cge_ctx.csv")
cge_group_100_sctx = pd.read_csv(f"{neighdir}/neighbourhood_atrophy_cross_SchaeferSubcortex114Parcels_group_cge_sctx.csv")
cge_group_400_ctx = pd.read_csv(f"{neighdir}/neighbourhood_atrophy_cross_SchaeferSubcortex414Parcels_group_cge_ctx.csv")
cge_group_400_sctx = pd.read_csv(f"{neighdir}/neighbourhood_atrophy_cross_SchaeferSubcortex414Parcels_group_cge_sctx.csv")
