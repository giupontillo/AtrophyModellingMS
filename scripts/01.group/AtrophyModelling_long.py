...
output_folder = f"{dir}/output/june/long_group_results"
...
plot_cortical_atrophy(atrophy_d100_ctx, "schaefer_100_fsa5", output_folder, "atrophy_long_group_100_ctx_map", color_range=(-10,10), cmap="RdBu_r")
plot_cortical_atrophy(atrophy_d400_ctx, "schaefer_400_fsa5", output_folder, "atrophy_long_group_400_ctx_map", color_range=(-10,10), cmap="RdBu_r")
...
plot_cortical_atrophy(atrophy_pfdr100_ctx, "schaefer_100_fsa5", output_folder, "atrophy_long_group_100_ctx_pfdr_map", color_range=(0,0.05), cmap="Reds")
plot_cortical_atrophy(atrophy_pfdr400_ctx, "schaefer_400_fsa5", output_folder, "atrophy_long_group_400_ctx_pfdr_map", color_range=(0,0.05), cmap="Reds")
 
plot_subcortical_atrophy(atrophy_pfdr100_sctx, output_folder, "atrophy_long_group_100_sctx_pfdr_map", color_range=(0, 0.05), cmap="Reds")
plot_subcortical_atrophy(atrophy_pfdr400_sctx, output_folder, "atrophy_long_group_400_sctx_pfdr_map", color_range=(0, 0.05), cmap="Reds")
