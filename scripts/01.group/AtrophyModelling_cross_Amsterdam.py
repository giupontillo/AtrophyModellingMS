...
atrophycross_dir = f'{dir}/data/atrophy_cross/old'

#atrophy_cross_group_100_fdr = pd.read_csv(f"{atrophycross_dir}/PrograMS_atrophy_baseline_SchaeferSubcortex114Parcels_group_pfdr.csv")
#atrophy_cross_group_400_fdr = pd.read_csv(f"{atrophycross_dir}/PrograMS_atrophy_baseline_SchaeferSubcortex414Parcels_group_pfdr.csv")

atrophy_cross_group_100 = pd.read_csv(f"{atrophycross_dir}/PrograMS_atrophy_baseline_SchaeferSubcortex114Parcels_group_cohend.csv")
#atrophy_cross_group_400 = pd.read_csv(f"{atrophycross_dir}/PrograMS_atrophy_baseline_SchaeferSubcortex414Parcels_group_cohend.csv")
#%%

mean_val = atrophy_cross_group_100.mean(axis=1).iloc[0]
std_val = atrophy_cross_group_100.std(axis=1, ddof=1).iloc[0] 
#%%
# ################# NEIGHBOUR DATA FROM AMSTERDAM ################# 
neighdir = f'{dir}/data/atrophy_cross/old'

neighcross_group_100_fc_ctx = pd.read_csv(f"{neighdir}/PrograMS_neighbourhood_atrophy_cross_SchaeferSubcortex114Parcels_fc_ctx.csv")
neighcross_group_100_fc_sctx = pd.read_csv(f"{neighdir}/PrograMS_neighbourhood_atrophy_cross_SchaeferSubcortex114Parcels_fc_sctx.csv")
neighcross_group_100_sc_ctx = pd.read_csv(f"{neighdir}/PrograMS_neighbourhood_atrophy_cross_SchaeferSubcortex114Parcels_sc_ctx.csv")
neighcross_group_100_sc_sctx = pd.read_csv(f"{neighdir}/PrograMS_neighbourhood_atrophy_cross_SchaeferSubcortex114Parcels_sc_sctx.csv")

# neighcross_group_400_fc_ctx = pd.read_csv(f"{neighdir}/PrograMS_neighbourhood_atrophy_cross_SchaeferSubcortex414Parcels_group_fc_ctx.csv")
# neighcross_group_400_fc_sctx = pd.read_csv(f"{neighdir}/PrograMS_neighbourhood_atrophy_cross_SchaeferSubcortex414Parcels_group_fc_sctx.csv")
# neighcross_group_400_sc_ctx = pd.read_csv(f"{neighdir}/PrograMS_neighbourhood_atrophy_cross_SchaeferSubcortex414Parcels_group_sc_ctx.csv")
# neighcross_group_400_sc_sctx = pd.read_csv(f"{neighdir}/PrograMS_neighbourhood_atrophy_cross_SchaeferSubcortex414Parcels_group_sc_sctx.csv")

#%%
# ################# DISCONNECTOME DATA FROM AMSTERDAM ################# 
discdir = f'{dir}/data/disc/old'

disc_group_100_ctx = pd.read_csv(f"{discdir}/PrograMS_disc_SchaeferSubcortex114Parcels_group_ctx.csv", header=None)
disc_group_100_sctx = pd.read_csv(f"{discdir}/PrograMS_disc_SchaeferSubcortex114Parcels_group_sctx.csv", header=None)

# disc_group_400_ctx = pd.read_csv(f"{discdir}/PrograMS_disc_SchaeferSubcortex414Parcels_group_ctx.csv", header=None)
# disc_group_400_sctx = pd.read_csv(f"{discdir}/PrograMS_disc_SchaeferSubcortex414Parcels_group_sctx.csv", header=None)

#%%
# ################# NEIGHBOUR DATA WEIGHTED BY GENE #####
cgedir = f'{dir}/data/neighbourhood_atrophy/old'
cge_group_100_ctx = pd.read_csv(f"{cgedir}/PrograMS_neighbourhood_atrophy_cross_SchaeferSubcortex114Parcels_group_cge_ctx.csv")
cge_group_100_sctx = pd.read_csv(f"{cgedir}/PrograMS_neighbourhood_atrophy_cross_SchaeferSubcortex114Parcels_group_cge_sctx.csv")
# cge_group_400_ctx = pd.read_csv(f"{neighdir}/PrograMS_neighbourhood_atrophy_cross_SchaeferSubcortex414Parcels_group_cge_ctx.csv")
# cge_group_400_sctx = pd.read_csv(f"{neighdir}/PrograMS_neighbourhood_atrophy_cross_SchaeferSubcortex414Parcels_group_cge_sctx.csv")
...
# PLOT DATA 
#==============================================================================
output_folder = f"{dir}/output/sept/cross_amsterdam_ectrims"
os.makedirs(output_folder, exist_ok=True)

# ################# ATROPHY CROSS DATA FROM AMSTERDAM ################# 
atrophy_d100_ctx = atrophy_cross_group_100.iloc[:,:-14].to_numpy() #remove sctx
#atrophy_d400_ctx = atrophy_cross_group_400.iloc[:,:-14].to_numpy() #remove sctx

atrophy_d100_sctx = atrophy_cross_group_100.iloc[:,-14:].to_numpy().T.squeeze()  #remove cortical 
#atrophy_d400_sctx = atrophy_cross_group_100.iloc[:,-14:].to_numpy().T.squeeze()  #remove cortical 

#%%
plot_cortical_atrophy(atrophy_d100_ctx, "schaefer_100_fsa5", output_folder, "atrophy_cross_group_100_ctx_map", color_range=(-0.8,0.8), cmap="RdBu_r")
#plot_cortical_atrophy(atrophy_d400_ctx, "schaefer_400_fsa5", output_folder, "atrophy_cross_group_400_ctx_map", color_range=(-0.8,0.8), cmap="RdBu_r")
 
plot_subcortical_atrophy(atrophy_d100_sctx, output_folder, "atrophy_cross_group_100_sctx_map", color_range=(-0.8, 0.8), cmap="RdBu_r")
#plot_subcortical_atrophy(atrophy_d400_sctx, output_folder, "atrophy_cross_group_400_sctx_map", color_range=(-0.8, 0.8), cmap="RdBu_r")

#%%

# ################# ATROPHY CROSS DATA FROM AMSTERDAM ################# 
#atrophy_pfdr100_ctx = atrophy_cross_group_100_fdr.iloc[:,:-14].to_numpy() #remove sctx
#atrophy_pfdr400_ctx = atrophy_cross_group_400_fdr.iloc[:,:-14].to_numpy() #remove sctx

#atrophy_pfdr100_sctx = atrophy_cross_group_100_fdr.iloc[:,-14:].to_numpy().T.squeeze()  #remove cortical 
#atrophy_pfdr400_sctx = atrophy_cross_group_400_fdr.iloc[:,-14:].to_numpy().T.squeeze()  #remove cortical 
...
#plot_cortical_atrophy(log_atrophy_pfdr100_ctx, "schaefer_100_fsa5", output_folder, "atrophy_cross_group_100_ctx_pfdr_map", color_range=(1.3,20), cmap="Reds")
#plot_cortical_atrophy(log_atrophy_pfdr400_ctx, "schaefer_400_fsa5", output_folder, "atrophy_cross_group_400_ctx_pfdr_map", color_range=(1.3,20), cmap="Reds")
 
#plot_subcortical_atrophy(log_atrophy_pfdr100_sctx, output_folder, "atrophy_cross_group_100_sctx_pfdr_map", color_range=(1.3,20), cmap="Reds")
#plot_subcortical_atrophy(log_atrophy_pfdr400_sctx, output_folder, "atrophy_cross_group_400_sctx_pfdr_map", color_range=(1.3,20), cmap="Reds")
...
#!!!! WARNING 400 parcellation needs to be corrected
...
# parcel_group_100_ctx = pd.read_csv(f"{discdir}/parcel_disc_SchaeferSubcortex114Parcels_group_ctx.csv", header=None)
# parcel_group_100_sctx = pd.read_csv(f"{discdir}/parcel_disc_SchaeferSubcortex114Parcels_group_sctx.csv", header=None)

# parcel_group_400_ctx = pd.read_csv(f"{discdir}/parcel_disc_SchaeferSubcortex414Parcels_group_ctx.csv", header=None)
# parcel_group_400_sctx = pd.read_csv(f"{discdir}/parcel_disc_SchaeferSubcortex414Parcels_group_sctx.csv", header=None)

# plot_cortical_atrophy(parcel_group_100_ctx.squeeze(), "schaefer_100_fsa5", output_folder, "parcel_group_100_ctx_map", color_range=(0,0.3), cmap="Reds")
# plot_cortical_atrophy(parcel_group_400_ctx.squeeze(), "schaefer_400_fsa5", output_folder, "parcel_group_400_ctx_map", color_range=(0,0.3), cmap="Reds")

# plot_subcortical_atrophy(parcel_group_100_sctx.squeeze(), output_folder, "parcel_group_100_sctx_map", color_range=(0,0.3), cmap="Reds")
# plot_subcortical_atrophy(parcel_group_400_sctx.squeeze(), output_folder, "parcel_group_400_sctx_map", color_range=(0,0.3), cmap="Reds")
#%%
...
plot_cortical_atrophy(cge_group_100_ctx, "schaefer_100_fsa5", output_folder, "cge_group_100_ctx_map", color_range=(0,0.2), cmap="Reds")
# plot_cortical_atrophy(cge_group_400_ctx, "schaefer_400_fsa5", output_folder, "cge_group_400_ctx_map", color_range=(0,0.2), cmap="Reds")

plot_subcortical_atrophy(cge_group_100_sctx, output_folder, "cge_group_100_sctx_map", color_range=(-0.2,0), cmap="Reds_r")
# plot_subcortical_atrophy(cge_group_400_sctx, output_folder, "cge_group_400_sctx_map", color_range=(-0.2,0), cmap="Reds_r")
...
rvals_crossgroup_100, p_and_d_crossgroup_100, meas_crossgroup_100 = nodal_stress(fc_ctx_dc_100, fc_sctx_dc_100, sc_ctx_dc_100, sc_sctx_dc_100, atrophy_cross_group_100, "schaefer_100")
# rvals_crossgroup_400, p_and_d_crossgroup_400, meas_crossgroup_400 = nodal_stress(fc_ctx_dc_400, fc_sctx_dc_400, sc_ctx_dc_400, sc_sctx_dc_400, atrophy_cross_group_400, "schaefer_400")
    
plot_null_distributions(p_and_d_crossgroup_100, rvals_crossgroup_100, "plot_nodalstress_group_cross_100_null" )
# plot_null_distributions(p_and_d_crossgroup_400, rvals_crossgroup_400, "plot_nodalstress_group_cross_400_null")

plot_hubs_vs_atrophy(p_and_d_crossgroup_100, rvals_crossgroup_100, meas_crossgroup_100, "plot_nodalstress_group_cross_100")
# plot_hubs_vs_atrophy(p_and_d_crossgroup_400, rvals_crossgroup_400, meas_crossgroup_400, "plot_nodalstress_group_cross_400")
...
rvals_neighcross_100, p_and_d_neighcross_100, meas_neighcross_100 = neighbour_atrophy(neighcross_group_100_fc_ctx, neighcross_group_100_fc_sctx, neighcross_group_100_sc_ctx, neighcross_group_100_sc_sctx, atrophy_cross_group_100, "schaefer_100")
# rvals_neighcross_400, p_and_d_neighcross_400, meas_neighcross_400 = neighbour_atrophy(neighcross_group_400_fc_ctx, neighcross_group_400_fc_sctx, neighcross_group_400_sc_ctx, neighcross_group_400_sc_sctx, atrophy_cross_group_400, "schaefer_400")
...
rvals_disc_100, p_and_d_disc_100, meas_disc_100  = axonal_disc(disc_ctx_dc_100, disc_sctx_dc_100, atrophy_cross_group_100, "schaefer_100")
# rvals_disc_400, p_and_d_disc_400, meas_disc_400  = axonal_disc(disc_ctx_dc_400, disc_sctx_dc_100, atrophy_cross_group_400, "schaefer_400")

plot_null_distributions(p_and_d_disc_100, rvals_disc_100, "plot_disc_group_cross_100_null")
# plot_null_distributions(p_and_d_disc_400, rvals_disc_400, "plot_disc_group_cross_400_null")

plot_hubs_vs_atrophy(p_and_d_disc_100, rvals_disc_100, meas_disc_100, "plot_disc_group_cross_100")
# plot_hubs_vs_atrophy(p_and_d_disc_400, rvals_disc_400, meas_disc_400, "plot_disc_group_cross_400")

#%%

# rvals_parcel_100, p_and_d_parcel_100, meas_parcel_100  = axonal_disc(parcel_group_100_ctx.squeeze(), parcel_group_100_sctx.squeeze(), atrophy_cross_group_100, "schaefer_100")
# rvals_parcel_400, p_and_d_parcel_400, meas_parcel_400  = axonal_disc(parcel_group_400_ctx.squeeze(), parcel_group_400_sctx.squeeze(), atrophy_cross_group_400, "schaefer_400")
...
rvals_cge_100, p_and_d_cge_100, meas_cge_100 = transcriptomic_vulnerablity(cge_group_100_ctx, cge_group_100_sctx, atrophy_cross_group_100, "schaefer_100")
#rvals_cge_400, p_and_d_cge_400, meas_cge_400 = transcriptomic_vulnerablity(cge_group_400_ctx, cge_group_400_sctx, atrophy_cross_group_400, "schaefer_400")
