...
atrophy_d400=pd.read_csv(StringIO(args.row), header=None)

atrophy_d400.set_index(atrophy_d400.columns[0], inplace= True)
print(atrophy_d400)
subject_id = str(atrophy_d400.index[0])
