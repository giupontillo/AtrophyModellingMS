...
atrophy_d100 = pd.read_csv(f"{atrophydir}/atrophy_long_SchaeferSubcortex114Parcels_group_t-values.csv")
atrophy_d400 = pd.read_csv(f"{atrophydir}/atrophy_long_SchaeferSubcortex414Parcels_group_t-values.csv")
...
output_folder = f"{dir}/output/june/long_group_t-values_epi_results"
