...
csv_file="${atrophydir}/atrophy_baseline_SchaeferSubcortex414Parcels_individuals_wscore.csv"
...
echo $subject_id
touch_file="${parent_dir}/output/june/cross_indv_epi_results/${subject_id}_400.touch"
echo $touch_file			
...
if [ ! -e ${touch_file} ]; then
	...
	python ${parent_dir}/scripts/03.epicenter-mapping/epicenter-mapping_indv_400.py --row $full_row
